document.addEventListener('DOMContentLoaded', () => {
    ...
    const plants = [
        ...
        { type: 'activity', name: 'ФХУГЗГРЛВ', label: 'АКТИВНОСТЬ', segments: 3, iconPath: 'M12,3L1,9L12,15L21,10.09V17H23V9M5,13.18V17.18L12,21L19,17.18V13.18L12,17L5,13.18Z' },
        { type: 'mutation', name: 'ГТЖН', label: 'ИНДЕКС МУТАЦИИ', segments: 1, iconPath: 'M7,2V4H8V18A4,4 0 0,0 12,22A4,4 0 0,0 16,18V4H17V2H7M11,16C10.4,16 10,15.6 10,15C10,14.4 10.4,14 11,14C11.6,14 12,14.4 12,15C12,15.6 11.6,16 11,16M13,12C12.4,12 12,11.6 12,11C12,10.4 12.4,10 13,10C13.6,10 14,10.4 14,11C14,11.6 13.6,12 13,12M14,7H10V4H14V7Z', encrypted: true },
        ...
        { type: 'toxicity', name: 'В', label: 'ТОКСИЧНОСТЬ', segments: 1, iconPath: 'M2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2A10,10 0 0,0 2,12M12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4Z' },
        ...
        { type: 'concentration', name: 'ЗЛЧРФУЛЭУБЛ', label: 'КОНЦЕНТРАЦИЯ', segments: 6, iconPath: 'M12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20M12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22M11,10H13V12H11V10M11,14H13V16H11V14Z', encrypted: true },
