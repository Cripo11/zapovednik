...
const PLANTS = [
    ...
    { id: 'p2', name: 'Сраноклевер', icon: ICONS.clover },
    { id: 'p3', name: 'Блядокуст', icon: ICONS.vine },
    { id: 'p4', name: 'Хренодендрон', icon: ICONS.tree },
    { id: 'p5', name: 'Сиськоцвет', icon: ICONS.flower },
    { id: 'p6', name: 'Ёпрстник', icon: ICONS.grass },
    ...
    { id: 'p12', name: 'Похерник', icon: ICONS.flower },
...
const TARGET_IDS = new Set(['p2', 'p4', 'p6', 'p12']);
